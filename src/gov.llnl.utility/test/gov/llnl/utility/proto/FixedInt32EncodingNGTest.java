 ...
 * @author nelson85
 */
public class FixedInt32EncodingNGTest
{

  public FixedInt32EncodingNGTest() throws ProtoException
  {
  }
  ...
  public static class AProto extends MessageEncoding<A>
  {
    ...
    static
    {
      ...
      builder.field("i", 1).type(Type.FixedInt32).asInt(A::getI, A::setI);
      builder.field("j", 2).type(Type.FixedInt32).as(A::getJ, A::setJ);
  ...
  public void testParseField() throws Exception
  {
    ...
    b.putInt(12345);
    b.rewind();
    FixedInt32Encoding instance = new FixedInt32Encoding();
