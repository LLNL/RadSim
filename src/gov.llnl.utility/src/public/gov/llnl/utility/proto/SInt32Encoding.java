...
/**
 * Encoding for an integer with scissor as variable encoding.
 *
 * @author nelson85
 */
class SInt32Encoding extends Int32Encoding
{
  final static SInt32Encoding INSTANCE = new SInt32Encoding();
          ...
          throws ProtoException
  {
    ...
    int v = Int32Encoding.decodeVInt32(b);
    if ((v & 1) == 0)
      v = v / 2;
    else
      v = -v / 2 - 1;
    if (field.setter instanceof BiConsumer)
      ...
      ((ObjIntConsumer) field.setter).accept(o, v);
  }
