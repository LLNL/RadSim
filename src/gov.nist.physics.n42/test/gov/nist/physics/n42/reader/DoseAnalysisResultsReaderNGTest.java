 ...
 * @author pham21
 */
public class DoseAnalysisResultsReaderNGTest
{
  
  public DoseAnalysisResultsReaderNGTest()
  {
  }
  ...
  /**
   * Test of start method, of class DoseAnalysisResultsReader.
   */
  @Test
  public void testStart() throws Exception
  {
    ...
    DoseAnalysisResultsReader instance = new DoseAnalysisResultsReader();
    DoseAnalysisResults expResult = null;
    DoseAnalysisResults result = instance.start(context, attr);
  ...
  /**
   * Test of getHandlers method, of class DoseAnalysisResultsReader.
   */
  @Test
